const global = {
    ...
    api: {
        apiKey: 'ca2e35fc96af72921a64a35184214902',
...
async function getMovieDetails() {
    ...
    const movie_video = await fetchAPIData(`movie/${movieId}/videos`)
    // Overlay for background Image
    displayBackgroundImage('movie', movie.backdrop_path, movie_video.results[0].key)
...
function displayBackgroundImage(type, backgroundPath, video_key) {
    // if(video_key) {
    //     const videoUrl = `https://www.youtube.com/embed?v=${video_key}`;
    //     const videoElement = document.createElement('embed');
    ...
    //     if(type === 'movie') {
    //         document.querySelector('#movie-details').appendChild(videoElement);
    //     }
    //     else {
    //         document.querySelector('#show-details').appendChild(videoElement);
        // }
        ...
        //                 event.target.mute(); // Mute the video if needed
